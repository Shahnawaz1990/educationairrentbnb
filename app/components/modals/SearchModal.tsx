...
const SearchModal = () => {
    ...
    if(step === STEPS.INFO){
      bodyContent = (
        <div className='flex flex-col gap-8'>
          <Heading title='More Infomration' subtitle='Find you perfect place!' />
  ...
  return (
    <Modal isOpen={searchModal.isOpen} onClose={searchModal.onClose} onSubmit={onSubmit} title="Filters" actionLabel="Search" secondaryActionLabel={secondaryActionLabel}
    secondaryAction={step === STEPS.LOCATION ? undefined : onBack} body={bodyContent} />
  )
}
